<?php
        ...
        if(isset($_GET['id'])){
				...
				$sql = "SELECT * FROM samyang_ramyeon INNER JOIN nutrient_syr ON samyang_ramyeon.nutrient_id = nutrient_syr.raw_id INNER JOIN raw_syr on nutrient_syr.raw_id = raw_syr.id inner join badadd_syr1 on raw_syr.badadd_syr_id = badadd_syr1.id  WHERE nutrient_id = $id";
										...
										<div class="col-6 col-12-medium">
											...
											<section class="performance-facts">
											  ...
											  <table class="performance-facts__table">
												<tbody>
												  <tr class="thick-row"><td colspan="3" class="small-info">
													  1회 제공량 당 함량</td></tr>
												  <tr><th colspan="2"><b>1회 제공량</b>
												  </th><td><b><?php echo $ramyeon['amount'];?></b>
												  </td></tr><tr class="thin-end"><td colspan="2">
												  <b>에너지(kcal)</b></td><td>
												  <b><?php echo $ramyeon['calories'];?></b></td></tr>
												  <tr><th colspan="2"><b>단백질(g)</b></th><td>
												  <b><?php echo $ramyeon['protein'];?></b></td></tr>
												  <tr><th colspan="2"><b>지방(g)</b></th><td>
